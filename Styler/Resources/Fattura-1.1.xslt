		...
		<html>
			<head>
				...
				<style type="text/css">
					...
					#fattura-elettronica .versione { font-size: 9pt; float:right; color: #777777; }
					#fattura-elettronica h1 { padding: 20px 0 0 0; margin: 0; font-size: 20pt; }
					#fattura-elettronica h2 { padding: 20px 0 0 0; margin: 0; font-size: 16pt; }
					#fattura-elettronica h3 { padding: 20px 0 0 0; margin: 0; font-size: 14pt; }
					#fattura-elettronica h4 { padding: 20px 0 0 0; margin: 0; font-size: 12pt; }
					#fattura-elettronica h5 { padding: 10px 0 0 0; margin: 0;	font-size: 10pt; font-style: italic; }
					#fattura-elettronica ul { list-style-type: none; margin: 0 !important; padding: 15px 0 0 40px !important; }
					#fattura-elettronica ul li { font-size: 9pt; }
					...
					#fattura-elettronica div.footer { padding: 50px 0 0 0; margin: 0; font-size: 9pt; text-align: center; color: #777777; }
				</style>
			</head>
			<body>
